...
loa_main <- loa |> filter(dataset == "main", var %in% names(main))
...
# saveRDS(an_main_w, "outputs/rawr/an_main_w.RDS")
an_main_w <-readRDS("outputs/rawr/an_main_w.RDS")
...
#   an_main_unw <- tibble()
# }
# saveRDS(an_main_unw, "outputs/rawr/an_main_unw.RDS")
an_main_unw <-readRDS("outputs/rawr/an_main_unw.RDS")
...
#   an_loop_w <- tibble()
# }
# saveRDS(an_loop_w, "outputs/rawr/an_loop_w.RDS")
an_loop_w <-readRDS("outputs/rawr/an_loop_w.RDS")
...
#   an_loop_unw <- tibble()
# }
# saveRDS(an_loop_unw, "outputs/rawr/an_loop_unw.RDS")
an_loop_unw <-readRDS("outputs/rawr/an_loop_unw.RDS")
...
an %>% saveRDS("outputs/rawr/an.RDS")
